...
<p>{{code &quot;part1.go&quot; <code>/^type Page/</code> <code>/}/</code>}}</p>
<p>
...
<p>{{code &quot;part1.go&quot; <code>/^func.*Page.*save/</code> <code>/}/</code>}}</p>
<p>
...
<p>{{code &quot;part1-noerror.go&quot; <code>/^func loadPage/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;part1.go&quot; <code>/^func loadPage/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;part1.go&quot; <code>/^func main/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;part2.go&quot; <code>/^func viewHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;part2.go&quot; <code>/^func main/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-noclosure.go&quot; <code>/^func main/</code> <code>/^}/</code>}}</p>
<p>
函数 <code>editHandler</code> 加载页面（若不存在则创建一个空的 <code>Page</code> 结构体），并显示一个 HTML 表单。
</p>

<p>{{code &quot;notemplate.go&quot; <code>/^func editHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-noerror.go&quot; <code>/^func editHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-noerror.go&quot; <code>/^func viewHandler/</code> <code>/^}/</code>}}</p>
<p>
注意两个处理器中使用了几乎相同的模板代码。让我们通过将模板代码移至独立函数来消除这种重复：
</p>

<p>{{code &quot;final-template.go&quot; <code>/^func renderTemplate/</code> <code>/^}/</code>}}</p>
<p>
并修改处理器以使用该函数：
</p>

<p>{{code &quot;final-template.go&quot; <code>/^func viewHandler/</code> <code>/^}/</code>}}<br>{{code &quot;final-template.go&quot; <code>/^func editHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;part3-errorhandling.go&quot; <code>/^func viewHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-template.go&quot; <code>/^func saveHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-parsetemplate.go&quot; <code>/^func renderTemplate/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;part3-errorhandling.go&quot; <code>/^func saveHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final.go&quot; <code>/var templates/</code>}}</p>
<p>
...
<p>{{code &quot;final.go&quot; <code>/func renderTemplate/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-noclosure.go&quot; <code>/^var validPath/</code>}}</p>
<p>
...
<p>{{code &quot;final-noclosure.go&quot; <code>/func getTitle/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final-noclosure.go&quot; <code>/^func viewHandler/</code> <code>/^}/</code>}}<br>{{code &quot;final-noclosure.go&quot; <code>/^func editHandler/</code> <code>/^}/</code>}}<br>{{code &quot;final-noclosure.go&quot; <code>/^func saveHandler/</code> <code>/^}/</code>}}</p>
<h2>函数字面量与闭包</h2>
...
<p>{{code &quot;final.go&quot; <code>/func makeHandler/</code> <code>/^}/</code>}}</p>
<p>
...
<p>{{code &quot;final.go&quot; <code>/func main/</code> <code>/^}/</code>}}</p>
<p>
最后从处理器函数中移除对 <code>getTitle</code> 的调用，使代码更加简洁：
</p>

<p>{{code &quot;final.go&quot; <code>/^func viewHandler/</code> <code>/^}/</code>}}<br>{{code &quot;final.go&quot; <code>/^func editHandler/</code> <code>/^}/</code>}}<br>{{code &quot;final.go&quot; <code>/^func saveHandler/</code> <code>/^}/</code>}}</p>
<h2>运行测试</h2>
